...
- **Step 4 Q8: controlled `conceptKind` scheme (2026-09-22).**
  ...
  value-stream layer (Appendix A): value-stream capabilities become
  CapabilityKind concepts with "realized by" links to processes.
...
- Domain / value stream / stages / capabilities-as-views → parked
  overlays (this item).
- Capability kind → Q8 `conceptKind` (Step 4): value-stream capabilities
  become CapabilityKind concepts with "realized by" links to processes.
